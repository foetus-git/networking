...
The term **network** may refer to a series of meaning depending on the specific field in which it is used (mathematic, biology, computer, AI, socilas).
In general terms it can be defined as the relation between different connected objects.

We will see the term from a *communication* perspective and we will start exactly from here.
